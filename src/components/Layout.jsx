...
export function Layout({ children, page }) {
  ...
  return (
    <>
      ...
      >
        {/* Navigation. */}
        {!page.product.isJsxPage && hasNavigation && (
          <div className="hidden lg:relative lg:block lg:flex-none">
            ...
            <div className="sticky top-[7rem] -ml-0.5 h-[calc(100vh-7rem)] overflow-y-auto overflow-x-hidden py-16 pl-0.5 scrollbar-thin scrollbar-track-neutral-200 scrollbar-thumb-neutral-400 dark:scrollbar-track-neutral-800 dark:scrollbar-thumb-neutral-600">
              <Navigation
